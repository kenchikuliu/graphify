...
![AI 读大项目缺的不是更长上下文](scene-frames/01-hook.png)
...
![我只认这四个产物](scene-frames/02-outputs.png)
...
![GRAPH_REPORT.md 像一张读项目路线图](scene-frames/03-report.png)
...
![graph.html 不是装饰图](scene-frames/04-graph.png)
...
![query 返回的是子图，不是一句漂亮摘要](scene-frames/05-query.png)
...
![关系有置信度，才方便复核](scene-frames/06-confidence.png)
...
![这篇就按“实测证据链”来写](scene-frames/07-close.png)
